...
- `OU_MINING.md` - mining log for the OU CHEM 1315/1415 exam archives (advanced-band content, harder than IMAT/Heritage). E1 done: inventory, unit-structure correction, topic-ladder feeds, and the quiz mechanics the OU question formats suggest.
