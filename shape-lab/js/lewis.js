  ...
  },
  {
    ...
    steps: [
      { t: "Count: C brings 4, each O brings 6, and the 2− charge donates <strong>two</strong> extra electrons: 4 + 18 + 2 = <strong>24 electrons</strong>. Brackets and charge up front.",
        scene: { atoms: [{ el: "C", x: 0, y: 6, lone: 4 }, { el: "O", x: 0, y: -80, lone: 6 }, { el: "O", x: -82, y: 58, lone: 6 }, { el: "O", x: 82, y: 58, lone: 6 }], bracket: { x0: -128, y0: -108, x1: 128, y1: 100, q: "2−" }, labels: [{ x: 0, y: 108, t: "4 + 6·3 + 2 = 24 e⁻", bold: true }] } },
      { t: "Skeleton: C central — needs the most bonds, less electronegative than O. Three singles, symmetric.",
        scene: { atoms: [{ el: "C", x: 0, y: 6 }, { el: "O", x: 0, y: -80 }, { el: "O", x: -82, y: 58 }, { el: "O", x: 82, y: 58 }], bonds: [{ a: 0, b: 1 }, { a: 0, b: 2 }, { a: 0, b: 3 }], bracket: { x0: -128, y0: -108, x1: 128, y1: 100, q: "2−" }, labels: [{ x: 0, y: 108, t: "3 bonds = 6 e⁻ used" }] } },
      { t: "Octets: three pairs on each O, one pair on C. The trial structure.",
        scene: { atoms: [{ el: "C", x: 0, y: 6, lone: 2 }, { el: "O", x: 0, y: -80, lone: 6 }, { el: "O", x: -82, y: 58, lone: 6 }, { el: "O", x: 82, y: 58, lone: 6 }], bonds: [{ a: 0, b: 1 }, { a: 0, b: 2 }, { a: 0, b: 3 }], bracket: { x0: -128, y0: -108, x1: 128, y1: 100, q: "2−" }, labels: [{ x: 0, y: 108, t: "trial: 6 + 18 + 2 = 26 e⁻ — two too many!", bold: true, color: "#b4502f" }] } },
      { t: "26 &gt; 24: erase two pairs, draw one bond — one C–O becomes C=O. Count: 8 + 16 = <strong>24</strong>. ✓ (Recognize the move? Nitrate, exactly.)",
        scene: { atoms: [{ el: "C", x: 0, y: 6 }, { el: "O", x: 0, y: -80, lone: 4 }, { el: "O", x: -82, y: 58, lone: 6 }, { el: "O", x: 82, y: 58, lone: 6 }], bonds: [{ a: 0, b: 1, order: 2 }, { a: 0, b: 2 }, { a: 0, b: 3 }], bracket: { x0: -128, y0: -108, x1: 128, y1: 100, q: "2−" }, labels: [{ x: 0, y: 108, t: "8 + 16 = 24 ✓", bold: true, color: "#356b45" }] } },
  ...
  },
  {
    ...
    steps: [
      { t: "Count: S brings 6, each O brings 6: 6 + 18 = <strong>24 electrons</strong>. Neutral — no brackets today.",
        scene: { atoms: [{ el: "S", x: 0, y: 6, lone: 6 }, { el: "O", x: 0, y: -80, lone: 6 }, { el: "O", x: -82, y: 58, lone: 6 }, { el: "O", x: 82, y: 58, lone: 6 }], labels: [{ x: 0, y: 108, t: "6 + 6·3 = 24 e⁻", bold: true }] } },
      { t: "Skeleton: S central, three singles.",
        scene: { atoms: [{ el: "S", x: 0, y: 6 }, { el: "O", x: 0, y: -80 }, { el: "O", x: -82, y: 58 }, { el: "O", x: 82, y: 58 }], bonds: [{ a: 0, b: 1 }, { a: 0, b: 2 }, { a: 0, b: 3 }], labels: [{ x: 0, y: 108, t: "3 bonds = 6 e⁻ used" }] } },
      { t: "Octets: three pairs per O, one pair on S. Trial: 6 + 18 + 2 = 26 — two too many, so erase two pairs, draw a bond: one S=O. Count: 8 + 16 = <strong>24</strong> ✓.",
        scene: { atoms: [{ el: "S", x: 0, y: 6 }, { el: "O", x: 0, y: -80, lone: 4 }, { el: "O", x: -82, y: 58, lone: 6 }, { el: "O", x: 82, y: 58, lone: 6 }], bonds: [{ a: 0, b: 1, order: 2 }, { a: 0, b: 2 }, { a: 0, b: 3 }], labels: [{ x: 0, y: 108, t: "8 + 16 = 24 ✓ … but wait", bold: true }] } },
      { t: "The count closes — but check the books: S is 6−0−4 = <strong>+2</strong>. Not allowed. A +2 means the drawing is lying, and step 5 exists precisely for this moment.",
        scene: { atoms: [{ el: "S", x: 0, y: 6, fc: "+2" }, { el: "O", x: 0, y: -80, lone: 4, fc: "0" }, { el: "O", x: -82, y: 58, lone: 6, fc: "−1" }, { el: "O", x: 82, y: 58, lone: 6, fc: "−1" }], bonds: [{ a: 0, b: 1, order: 2 }, { a: 0, b: 2 }, { a: 0, b: 3 }], labels: [{ x: 0, y: 108, t: "net 0 ✓, but +2 on S — fix it", bold: true, color: "#b4502f" }] } },
      { t: "S is <strong>row 3</strong> — it may hold more than 8. Trade a lone pair from each remaining O for a bond: three S=O doubles. Now S is 6−0−6 = 0 and every O is 6−4−2 = 0. All zero.",
        scene: { atoms: [{ el: "S", x: 0, y: 6, fc: "0" }, { el: "O", x: 0, y: -80, lone: 4, fc: "0" }, { el: "O", x: -82, y: 58, lone: 4, fc: "0" }, { el: "O", x: 82, y: 58, lone: 4, fc: "0" }], bonds: [{ a: 0, b: 1, order: 2 }, { a: 0, b: 2, order: 2 }, { a: 0, b: 3, order: 2 }], labels: [{ x: 0, y: 108, t: "12 + 12 = 24 ✓ — S holds 12", bold: true, color: "#356b45" }] } },
      { t: "Verify: exact count ✓, all formal charges zero ✓, S carries 12 electrons — an <strong>expanded octet</strong>, the row-3 privilege nitrogen will never have. Three identical doubles at 120°: trigonal planar, and perfectly nonpolar despite three ferociously polar bonds.",
        scene: { atoms: [{ el: "S", x: 0, y: 6 }, { el: "O", x: 0, y: -80, lone: 4 }, { el: "O", x: -82, y: 58, lone: 4 }, { el: "O", x: 82, y: 58, lone: 4 }], bonds: [{ a: 0, b: 1, order: 2 }, { a: 0, b: 2, order: 2 }, { a: 0, b: 3, order: 2 }], labels: [{ x: 0, y: 108, t: "the expansion ✓", bold: true, color: "#356b45" }] } },
    ],
  },
  {
    ...
    steps: [
      { t: "Count: S brings 6, each F brings 7: 6 + 28 = <strong>34 electrons</strong>.",
        scene: { atoms: [{ el: "S", x: 0, y: 0, lone: 6 }, { el: "F", x: -75, y: -62, lone: 7 }, { el: "F", x: 75, y: -62, lone: 7 }, { el: "F", x: -75, y: 66, lone: 7 }, { el: "F", x: 75, y: 66, lone: 7 }], labels: [{ x: 0, y: 108, t: "6 + 7·4 = 34 e⁻", bold: true }] } },
      { t: "Skeleton: S central, four singles: 8 electrons used, 26 to place.",
        scene: { atoms: [{ el: "S", x: 0, y: 0 }, { el: "F", x: -75, y: -62 }, { el: "F", x: 75, y: -62 }, { el: "F", x: -75, y: 66 }, { el: "F", x: 75, y: 66 }], bonds: [{ a: 0, b: 1 }, { a: 0, b: 2 }, { a: 0, b: 3 }, { a: 0, b: 4 }], labels: [{ x: 0, y: 108, t: "4 bonds = 8 e⁻ used" }] } },
      { t: "Octets: three pairs on every F takes 24 of the 26. <strong>Two electrons remain.</strong>",
        scene: { atoms: [{ el: "S", x: 0, y: 0 }, { el: "F", x: -75, y: -62, lone: 6 }, { el: "F", x: 75, y: -62, lone: 6 }, { el: "F", x: -75, y: 66, lone: 6 }, { el: "F", x: 75, y: 66, lone: 6 }], bonds: [{ a: 0, b: 1 }, { a: 0, b: 2 }, { a: 0, b: 3 }, { a: 0, b: 4 }], labels: [{ x: 0, y: 108, t: "8 + 24 = 32 — two electrons left over", bold: true, color: "#b4502f" }] } },
      { t: "Leftover electrons go to the <strong>central atom</strong> — S is row 3 and may hold extra. One lone pair on S: 8 + 24 + 2 = <strong>34</strong> ✓.",
        scene: { atoms: [{ el: "S", x: 0, y: 0, lone: 2 }, { el: "F", x: -75, y: -62, lone: 6 }, { el: "F", x: 75, y: -62, lone: 6 }, { el: "F", x: -75, y: 66, lone: 6 }, { el: "F", x: 75, y: 66, lone: 6 }], bonds: [{ a: 0, b: 1 }, { a: 0, b: 2 }, { a: 0, b: 3 }, { a: 0, b: 4 }], labels: [{ x: 0, y: 108, t: "34 = 34 ✓", bold: true, color: "#356b45" }] } },
      ...
      { t: "Verify: exact count ✓, charges zero ✓, S holds <strong>10</strong> — expanded, legal in row 3. Four atoms + one lone pair = five regions: the <strong>see-saw</strong> from the Geometries rung, lone pair in its roomy equatorial seat.",
        scene: { atoms: [{ el: "S", x: 0, y: 0, lone: 2 }, { el: "F", x: -75, y: -62, lone: 6 }, { el: "F", x: 75, y: -62, lone: 6 }, { el: "F", x: -75, y: 66, lone: 6 }, { el: "F", x: 75, y: 66, lone: 6 }], bonds: [{ a: 0, b: 1 }, { a: 0, b: 2 }, { a: 0, b: 3 }, { a: 0, b: 4 }], labels: [{ x: 0, y: 108, t: "10 on S · 5 regions · see-saw ✓", bold: true, color: "#356b45" }] } },
    ],
  },
  {
    ...
    steps: [
      { t: "Count: Xe brings 8, each O brings 6, each F brings 7: 8 + 12 + 14 = <strong>34 electrons</strong>. Yes, xenon bonds — the noble gas with paperwork.",
        scene: { atoms: [{ el: "Xe", x: 0, y: 0, lone: 8 }, { el: "O", x: -75, y: -62, lone: 6 }, { el: "O", x: 75, y: -62, lone: 6 }, { el: "F", x: -75, y: 66, lone: 7 }, { el: "F", x: 75, y: 66, lone: 7 }], labels: [{ x: 0, y: 108, t: "8 + 6·2 + 7·2 = 34 e⁻", bold: true }] } },
      { t: "Skeleton: Xe central, four singles: 8 used, 26 to place.",
        scene: { atoms: [{ el: "Xe", x: 0, y: 0 }, { el: "O", x: -75, y: -62 }, { el: "O", x: 75, y: -62 }, { el: "F", x: -75, y: 66 }, { el: "F", x: 75, y: 66 }], bonds: [{ a: 0, b: 1 }, { a: 0, b: 2 }, { a: 0, b: 3 }, { a: 0, b: 4 }], labels: [{ x: 0, y: 108, t: "4 bonds = 8 e⁻ used" }] } },
      { t: "Octets on the outside take 24; the last two electrons land on Xe as a lone pair: 34 ✓.",
        scene: { atoms: [{ el: "Xe", x: 0, y: 0, lone: 2 }, { el: "O", x: -75, y: -62, lone: 6 }, { el: "O", x: 75, y: -62, lone: 6 }, { el: "F", x: -75, y: 66, lone: 6 }, { el: "F", x: 75, y: 66, lone: 6 }], bonds: [{ a: 0, b: 1 }, { a: 0, b: 2 }, { a: 0, b: 3 }, { a: 0, b: 4 }], labels: [{ x: 0, y: 108, t: "8 + 24 + 2 = 34 ✓ … now check the books", bold: true }] } },
      { t: "Formal charges: Xe is 8−2−4 = <strong>+2</strong>, each O is −1. Net zero, but +2 is not allowed — minimize.",
        scene: { atoms: [{ el: "Xe", x: 0, y: 0, lone: 2, fc: "+2" }, { el: "O", x: -75, y: -62, lone: 6, fc: "−1" }, { el: "O", x: 75, y: -62, lone: 6, fc: "−1" }, { el: "F", x: -75, y: 66, lone: 6, fc: "0" }, { el: "F", x: 75, y: 66, lone: 6, fc: "0" }], bonds: [{ a: 0, b: 1 }, { a: 0, b: 2 }, { a: 0, b: 3 }, { a: 0, b: 4 }], labels: [{ x: 0, y: 108, t: "+2 on Xe — fix it", bold: true, color: "#b4502f" }] } },
      { t: "Xe is row 5 — expansion is cheap. Each O trades a lone pair for a double bond: Xe becomes 8−2−6 = 0, both O drop to 0. The doubles go to <strong>O, never F</strong>.",
        scene: { atoms: [{ el: "Xe", x: 0, y: 0, lone: 2, fc: "0" }, { el: "O", x: -75, y: -62, lone: 4, fc: "0" }, { el: "O", x: 75, y: -62, lone: 4, fc: "0" }, { el: "F", x: -75, y: 66, lone: 6, fc: "0" }, { el: "F", x: 75, y: 66, lone: 6, fc: "0" }], bonds: [{ a: 0, b: 1, order: 2 }, { a: 0, b: 2, order: 2 }, { a: 0, b: 3 }, { a: 0, b: 4 }], labels: [{ x: 0, y: 108, t: "all zeros ✓ — Xe holds 14", bold: true, color: "#356b45" }] } },
      { t: "Verify: 34 exactly ✓, charges zero ✓, Xe carries 14 electrons. Four atoms + one lone pair = five regions → <strong>see-saw</strong>, the same shape the quiz asked you about. Boss fight cleared — every rung of this game just met in one molecule.",
        scene: { atoms: [{ el: "Xe", x: 0, y: 0, lone: 2 }, { el: "O", x: -75, y: -62, lone: 4 }, { el: "O", x: 75, y: -62, lone: 4 }, { el: "F", x: -75, y: 66, lone: 6 }, { el: "F", x: 75, y: 66, lone: 6 }], bonds: [{ a: 0, b: 1, order: 2 }, { a: 0, b: 2, order: 2 }, { a: 0, b: 3 }, { a: 0, b: 4 }], labels: [{ x: 0, y: 108, t: "see-saw, cleared ✓", bold: true, color: "#356b45" }] } },
    ],
  },
  {
    ...
    steps: [
      { t: "Count: B brings 3, each Br brings 7: 3 + 21 = <strong>24 electrons</strong>.",
        scene: { atoms: [{ el: "B", x: 0, y: 6, lone: 3 }, { el: "Br", x: 0, y: -80, lone: 7 }, { el: "Br", x: -82, y: 58, lone: 7 }, { el: "Br", x: 82, y: 58, lone: 7 }], labels: [{ x: 0, y: 108, t: "3 + 7·3 = 24 e⁻", bold: true }] } },
      { t: "Skeleton: B central (lower electronegativity), three singles: 6 used, 18 left.",
        scene: { atoms: [{ el: "B", x: 0, y: 6 }, { el: "Br", x: 0, y: -80 }, { el: "Br", x: -82, y: 58 }, { el: "Br", x: 82, y: 58 }], bonds: [{ a: 0, b: 1 }, { a: 0, b: 2 }, { a: 0, b: 3 }], labels: [{ x: 0, y: 108, t: "3 bonds = 6 e⁻ used" }] } },
      { t: "Octets: the 18 remaining electrons complete all three bromines exactly. Nothing left for B — it sits at 6.",
        scene: { atoms: [{ el: "B", x: 0, y: 6 }, { el: "Br", x: 0, y: -80, lone: 6 }, { el: "Br", x: -82, y: 58, lone: 6 }, { el: "Br", x: 82, y: 58, lone: 6 }], bonds: [{ a: 0, b: 1 }, { a: 0, b: 2 }, { a: 0, b: 3 }], labels: [{ x: 0, y: 108, t: "6 + 18 = 24 — every electron placed" }] } },
      { t: "Count and compare: 24 = <strong>24</strong>, exactly. The arithmetic says done — trust the count over the itch to \"fix\" boron.",
        scene: { atoms: [{ el: "B", x: 0, y: 6 }, { el: "Br", x: 0, y: -80, lone: 6 }, { el: "Br", x: -82, y: 58, lone: 6 }, { el: "Br", x: 82, y: 58, lone: 6 }], bonds: [{ a: 0, b: 1 }, { a: 0, b: 2 }, { a: 0, b: 3 }], labels: [{ x: 0, y: 108, t: "24 = 24 ✓ — trust the count", bold: true, color: "#356b45" }] } },
      ...
      { t: "Verify: exact count ✓, charges zero ✓, octets — <strong>B signs the waiver</strong> at 6, just like Be at 4. Family trait. Flat, 120°, trigonal planar — and nonpolar by symmetry.",
        scene: { atoms: [{ el: "B", x: 0, y: 6 }, { el: "Br", x: 0, y: -80, lone: 6 }, { el: "Br", x: -82, y: 58, lone: 6 }, { el: "Br", x: 82, y: 58, lone: 6 }], bonds: [{ a: 0, b: 1 }, { a: 0, b: 2 }, { a: 0, b: 3 }], labels: [{ x: 0, y: 108, t: "the other rebel rests ✓", bold: true, color: "#356b45" }] } },
    ],
  },
];
